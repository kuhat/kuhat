...
+ My interests are web development, container orchestration, and so on. The technology I am using is Django, React.JS, Docker, Kubernetes, SpringBoot and so on. Java and Python are my favaorite languages, and I am quite familiar with Linux server, Restful API, Web Development and Cloud Computing.
